...
{/* The newsletter subscription state and function powerding telegra redirect and data archiving*/}
  ...
  <div className="container mx-auto max-w-4xl text-center">
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-xl mx-auto">
      ...
      <button
        ...
        disabled={loading}
        className={`bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-3 rounded-lg font-semibold transition-all 
