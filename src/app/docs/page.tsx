...
export const metadata = {
  title: "Developer Documentation | ClickShift",
  description: "Integrate ClickShift's trading intelligence into your applications. Build smarter trading bots, portfolio trackers, and alert systems.",
  openGraph: {
    title: "Build on ClickShift's Intelligence at scale | APIs with multiple endpoints",
    description: "Integrate ClickShift's trading intelligence into your applications. Build smarter trading bots, portfolio trackers, and alert systems.",
    images: ["/og-image.png"],
  }
}
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-6">
                    ...
                    <a href='https://alpha.clickshift.io' className="text-blue-400 hover:text-blue-300 text-sm font-semibold mt-3 inline-block">
                      Try Alpha →
                    </a>
                  </div>
                  ...
                  <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-6">
                    ...
                    <a href='https://leverage.clickshift.io' className="text-orange-400 hover:text-orange-300 text-sm font-semibold mt-3 inline-block">
                      Try Leverage →
                    </a>
                  </div>
                </div>
