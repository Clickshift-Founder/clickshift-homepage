...
const Footer = () => {
  ...
  return (
    <footer className="relative py-12 px-4 bg-slate-900 border-t border-slate-700" style={{ backgroundColor: 'rgb(15, 23, 42)' }}>
  ...
  <p style={{ color: '#888', fontSize: '12px', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
    ...
    of any user.
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-slate-400">
              ...
              <div><a href="https://www.linkedin.com/company/clickshifthq/" className="hover:text-white transition-colors">LinkedIn</a></div>
        ...
        <div className="text-center space-y-2 text-sm text-slate-400 mb-8">
          ...
          <div>Support: hello@clickshift.io, +1 945 409 3488</div>
          <div>HQ: Delaware, USA incorporation in progress.</div>
          <div>Ops: Dutse, aft Policesignboard, Tipper Garage,Bwari Area Council, Abuja</div>
        </div>
